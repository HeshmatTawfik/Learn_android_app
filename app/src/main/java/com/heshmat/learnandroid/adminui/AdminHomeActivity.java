package com.heshmat.learnandroid.adminui;
...
import com.heshmat.learnandroid.userui.TopicsFragment;
import com.mikhaellopez.circularimageview.CircularImageView;

public class AdminHomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    @BindView(R.id.adminDrawer)
    DrawerLayout drawer;
    @BindView(R.id.adminNested)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction()
                    .replace(R.id.fragmentContainer, AddTopicFragment.newInstance())
                    .commit();
        }
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.adminProfileMenuItem:
                break;

            case R.id.addTopicsMenuItem:
                fragment = AddTopicFragment.class;
                break;
